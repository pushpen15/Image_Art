...
public class PaneSubstractImage extends javax.swing.JPanel {
    ...
    public int [] resizeOriginalImageToLabel(int widthLabel, int heightLabel){
        ...
        int percentage = 1;
        int widthOriginalimage = myImage.getColumns();
        int heightOriginalImage = myImage.getRows();
        int width = getNewSizeByPercentage(widthOriginalimage, percentage);
        ...
        while(width < lblOriginalWidth && height < lblOriginalHeight){
            ...
            width = getNewSizeByPercentage(widthOriginalimage, percentage);
    ...
    private void initComponents() {
        ...
        title.setText("Subtract an Image");
        ...
        btnChooseAnImageTosubstract.setText("Choose an Image ");
        ...
        paneContainerImageAdded.setBackground(new java.awt.Color(51, 51, 51));

        lblImageToSubstract.setBackground(new java.awt.Color(51, 51, 51));
    ...
    private void btnChooseAnImageTosubstractActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChooseAnImageTosubstractActionPerformed
        ...
        if( n == JFileChooser.APPROVE_OPTION){
            ...
            if((numBands == 3 && frmPrincipal.modeRGB) || (numBands == 1 && frmPrincipal.modeGray)){
                ...
                btnChooseAnImageTosubstract.setText("Change Image");
