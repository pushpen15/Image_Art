...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    public int [] resizeOriginalImageToLabel(int widthLabel, int heightLabel){
        ...
        int percentage = 1;
        int widthOriginalimage = this.originalImage.getColumns();
    ...
    public int getNewSizeByPorcentage(int number, int percentage){
        return (number * percentage) / 100;
    }
    
    public void exit(){
        int option = JOptionPane.showConfirmDialog(null,
                "Everything applied to the image will be lost,are you sure ?","Exit",JOptionPane.YES_NO_OPTION);
    ...
    private void initComponents() {
        ...
        lblOriginalImage.setBackground(new java.awt.Color(102, 102, 102));
        ...
        paneContent.setBackground(new java.awt.Color(102, 102, 102));
        ...
        lblImageActual.setBackground(new java.awt.Color(51, 51, 51));
        ...
        itemFileOpen.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        ...
        itemFileSaveAs.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        itemFileSaveAs.setBackground(new java.awt.Color(102, 102, 102));
        itemFileSaveAs.setForeground(new java.awt.Color(255, 255, 255));
        itemFileSaveAs.setText("Save as ");
        ...
        itemFileClose.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F4, 0));
        itemFileClose.setBackground(new java.awt.Color(102, 102, 102));
        itemFileClose.setForeground(new java.awt.Color(255, 255, 255));
        itemFileClose.setText("Exit");
        ...
        menuSubstractImage.setText("Edit");
        ...
        itemSubstract.setText("Subtract Image");
        ...
        itemBinar.setText("Global Binarization");
        ...
        btnLocalBinarization.setText("Local Binarization");
        ...
        menuChannelBinarization.setText("Binarization by Channels");
        ...
        itemBinarizationByHistogram.setText("Binarization by Histogram");
        ...
        jMenuItem2.setText("Border of Robert");
        ...
        jMenuItem3.setText("Border of Prewit");
        ...
        jMenuItem4.setText("Borde of Sobel");
        ...
        itemFilterAverage.setText("Average");
        ...
        menuReset.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_R, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        ...
        menuConfiguracion.setText("Configuration");
        ...
        itemAddImage.setText("Add Image From");
        ...
        radioAddImageExtremeLeft.setText("Leftmost");
        ...
        radioAddImageCenter.setText("Centre");
        ...
        jMenu3.setText("Subtract Image From ");
        ...
        radioSubstractImageExtremeLeft.setText("Leftmost");
        ...
        radioSubstractImageCentered.setText("Centre");
    ...
    private void menuItemHSIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemHSIActionPerformed
        if(modeRGB){
            ...
            JOptionPane.showMessageDialog(null,"The image is applied in HSI mode ");
    ...
    private void itemMenuCMYKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemMenuCMYKActionPerformed
        if(modeRGB){
            ...
            JOptionPane.showMessageDialog(null,"The image was applied in CMYK mode ");
    ...
    private void itemFileSaveAsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemFileSaveAsActionPerformed
        try {
           /* JFileChooser chooser = new JFileChooser();
            ...
            setText("File Saved as: " + file.getName());
                } 
            }
            */
           String pm=  "C:\\Users\\goura\\Desktop\\imageEditor\\img.jpg";
            ImageIO.write(bufferedActualImage,"jpg",new File(pm));
    ...
    private void itemFileOpenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemFileOpenActionPerformed
        ...
        if(n == JFileChooser.APPROVE_OPTION){
            ...
            (null,"You will lose everything,are you sure ?","Close Image",JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
    ...
    private void itemPseudoColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemPseudoColorActionPerformed
        if(modeGray){
            ...
            JOptionPane.showMessageDialog(null,"Only applies to Greyscale images");
        }
