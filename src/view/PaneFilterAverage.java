...
public class PaneFilterAverage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Filter By Average");
        jLabel2.setOpaque(true);

        txt0.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        txt0.setForeground(new java.awt.Color(0, 0, 0));
        ...
        txt4.setForeground(java.awt.Color.black);
    ...
    private void btnApplyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApplyActionPerformed
        ...
        if(data0.equals("") || data1.equals("")|| data2.equals("")|| data3.equals("")|| data4.equals("")
            ...
            JOptionPane.showMessageDialog(null, "Complete the request data");
            return;
        }
