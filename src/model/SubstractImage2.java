...
public class SubstractImage2 {
    ...
    public BufferedImage substract(){
        ...
        if(frmPrincipal.modeRGB){
            ...
            else{System.out.println("Subtract from the centre");
        ...
        //we add the second image by average
        Color actual;
        Color add;
        int difference;
    ...
    public BufferedImage substractRGBCentered(){
        ...
        //create a new buffer with the currentimage
        ...
        //create another buffer with the image to subtract
        ...
        //create another buffer with the result image 
